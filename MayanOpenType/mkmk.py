...
mkmk = [
    ...
    {'name' : 'tcb1', 'marks' : '',
    'details' : [
        {'attach':['stems1-h'],'to':['tcb1_mks'],'anchor':'top'}
    ]},
    #Lookup
    {'name' : 'tcb2', 'marks' : '',
    'details' : [
        {'attach':['stems2-h'],'to':['tcb2_mks'],'anchor':'top'}
    ]},
    #Lookup
    {'name' : 'tcb0R', 'marks' : '',
    'details' : [
    ...
    'details' : [
        {'attach':['shapes_0'],'to':['tce0_mks'],'anchor':'right'}
    ]},
    #Lookup
    {'name' : 'tce1', 'marks' : '*tce1_mfc',
    'details' : [
        {'attach':['shapes_1'],'to':['tce1_mks'],'anchor':'right'}
    ]},
    #Lookup
    {'name' : 'tce2', 'marks' : '*tce2_mfc',
    'details' : [
        {'attach':['shapes_2'],'to':['tce2_mks'],'anchor':'right'}
    ]},
    #Lookup
