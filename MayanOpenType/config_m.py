...
pvar = {
    ...
    'fontfilename' : "Classic Maya", # Font name
    'fontsrc' : "../../fonts/Mayan/Classic/MayaClassic_v2-COLR.ttf", # Path to source font
    'fontout' : "classicMaya.ttf", # Path to write output font
    'sb'  : 105, # font side bearings
    'hfu' : 426, # horizontal, font units per hieroglyph unit (1372 per 6 hieroglyph units)
    'hhu' : 8, # horizontal, hieroglyph units
    'chu' : 6, # composite horizontal units (i.e., excludes wide non-composing widths)
    'vfu' : 337, # vertical, font units per hieroglyph unit (1358 per 6 hieroglyph units)
    'vhu' : 6, # vertical, hieroglyph units
    'issp' : 52, #Inter-sign spacing (+ allows glyph outlines to overlap, 0 no overlap)
    'vbase' : -337, # vertical baseline for hieroglyphs in font units 
    ...
    'tcs' : 0,
    'baseline' : 0, #align singletons to baseline for Hieratic
    'mirror'  : 0,  
    'vertical': 0,
    'glyphproperties' : 1,
    ...
    'test' : {'font':0,'gdef':0,'groups':0,'haln':0,'pres':0,'abvs':0,'blws':0,'rlig':0,'psts':0,'ss01':1,'rtlm':1,'vrt2':1,'gpos':0,'langsys':0,'anchors':0,'coda':0}
}